...
do
    if [[ $entry == *"json"* ]]; then
        echo "$entry"
        message_body="{ \"inferenceId\":\"zahar-test\",  \"messageType\":\"SIMILARITY\",\"orderId\":\"5da5d5164cedfd0050363a2e\",\"documentPath\":\"https://immoviewer-ai-research.s3-eu-west-1.amazonaws.com/storage/segmentation/floors_data_from_01.06.2020/$entry\"}"
