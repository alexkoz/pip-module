...
class S3HelperMock(S3Helper):
    ...
    def read_s3_object(self, s3_key) -> str:
        ...
        door_detection_result = '[{"color": 16777215, "computedValues": {"width": 71.97554911272209}, "doorDirectionRight": true, "doorType": 1, "elementId": "beta", "id": "door_108", "pathCorner": 1, "pathDirection": 1, "points": [{"x": 35.80435909946351,"y": -17.074991679581473},{"x": 44.21902962059778,"y": -20.455211700643225},{"x": 44.21902962059778,"y": 29.503975135145815},{"x": 35.80435923214196,"y": 24.985153472533955}],"positionOffset": 0,"room": "54kbn8dnx4.JPG","rotationOffset": 0,"text": "Door","type": "door", "zOrder": 3}, \
        ...
        if StringConstants.ROOM_BOX_KEY in s3_key:
            return roombox_result
        elif StringConstants.DOOR_DETECTION_KEY in s3_key:
